...
├── notes/阶段3-AI应用实战/
│   ├── 3.1-大模型部署与调用.md           # 第88-98集 ✅
│   ├── 3.2-提示词工程.md                 # 第99集   ✅
│   ├── 3.3-Streamlit入门.md              # 第101-102集 ✅
│   ├── 3.4-智能伴侣项目.md               # 第103-119集 ✅
│   ├── 3.5-文件操作.md                   # 第111-112集 ✅
│   └── */examples/*.py                   # 7个可运行示例
├── daily_summaries/
...
| 3.1 | 88-98 | 大模型部署与调用（Ollama/DeepSeek/网络/Apifox/会话记忆） | ✅ |
| 3.2 | 99 | 提示词工程（六步法+九要素） | ✅ |
| 3.3 | 101-102 | Streamlit 入门（纯 Python 写 Web） | ✅ |
| 3.4 | 103-119 | 智能伴侣项目（架构/流式/记忆/多会话管理） | ✅ |
| 3.5 | 111-112 | 文件操作（读写/with/JSON 持久化） | ✅ |

> 阶段 2 核心语法 + 阶段 3 AI 应用实战已全部完成。阶段 3 的里程碑：**从"能调 API"到做出完整可用的多会话 AI 伴侣应用**（v1→v4 迭代），具备 AI 应用开发的全链路能力。
...
| 指标 | 数量 |
|------|:--:|
| 学习笔记 | 12 份（2.1~2.7 + 3.1~3.5） |
| 可运行示例 | 36 个 `.py` 文件 |
| 每日复盘 | 12 天 |
| AI 智能体 | 2 个 |
| 学习 Skill | 1 个 |
| 完成集数 | 第 09-119 集（阶段2 + 阶段3 全部完成） |
